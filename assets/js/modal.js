...
const generateModal = () => {
  pageContainerElement.insertAdjacentHTML(
    "beforeend",
    `
    ...
    <div class="main-modal-entry">
        ...
        <div class="main-modal-channel-data-wrapper">
            <div class="main-modal-channel-data-entry">
                ...
                <input type="number" name="provision-percentage" id="provision-percentage-shop-${
                  channel.shopID
                }" value=${channel.percentageProvision.toFixed(2)} />
            </div>
            <div class="main-modal-channel-data-entry">
                <label for="provision-flat-shop-${channel.shopID}">Provision €</label>
                <input type="number" name="provision-flat" id="provision-flat-shop-${
                  channel.shopID
                }" value=${channel.flatProvision.toFixed(2)} />
            </div>
            <div class="main-modal-channel-data-entry">
                <label for="shipping-shop-${channel.shopID}">Versand €</label>
                <input type="number" name="shipping" id="shipping-shop-${
                  channel.shopID
                }" value=${channel.shippingCost.toFixed(2)} />
            </div>
        </div>
    </div>
    `;
  ...
  modalContainerElement.insertAdjacentHTML(
    "beforeend",
    `
